...
t_datos, t_tend, t_share, t_alert, t_model, t_pitch, t_inf, t_code = st.tabs(
    ["📄 Datos", "📈 Tendencias", "🥧 Shares", "🚨 Alertas", "🎯 Modelador", "⚡ Modelo rápido",
     "📑 Informe", "🧩 Código Colab"])
...
# ===== MODELO RÁPIDO (modo pitch) =====
with t_pitch:
    pitch.render(st, df_model, date_col, kpi_col, media_cols, ctrl_cols, P, tipos)
